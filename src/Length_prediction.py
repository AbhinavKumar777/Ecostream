...
def padding_material(new_product_features,new_product_type,new_product_weight):
    file_path = r'C:\Users\91971\Desktop\supply-chain-sustainability-main\stream\padding.csv'
    # Read the CSV file
...
def padding_length(new_product,predicted_padding_name):
    file_path = r'C:\Users\91971\Desktop\supply-chain-sustainability-main\stream\padding.csv'
    # Read the CSV file
    df = pd.read_csv(file_path)
    # Label encoding
    ...
    for target, model in models.items():
        ...
        # if(prediction[0]=='-'):
        #     prediction.replace("-", "")
        return f"Predicted padding volume for new product: {abs(prediction)}"
